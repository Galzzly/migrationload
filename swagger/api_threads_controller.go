...
func (a *ThreadsControllerApiService) FetchThreadDump(ctx context.Context) (string, *http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/threads"
...
@return ThreadStates
*/
func (a *ThreadsControllerApiService) FetchThreadStates(ctx context.Context) (ThreadStates, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue ThreadStates
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/threads/states"
