...
/*
DataAgentsControllerApiService Add new Data Transfer Agent
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *DataAgentsControllerApiAddDataAgentOpts - Optional Parameters:
     * @param "Body" (optional.Interface of DataAgentAddRequest) -
@return DataAgent
*/
...
func (a *DataAgentsControllerApiService) AddDataAgent(ctx context.Context, localVarOptionals *DataAgentsControllerApiAddDataAgentOpts) (DataAgent, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue DataAgent
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/scaling/dataagents/"
...
func (a *DataAgentsControllerApiService) DeleteDataAgent(ctx context.Context, agentName string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/scaling/dataagents/{agentName}"
