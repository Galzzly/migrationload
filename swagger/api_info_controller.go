...
@return string
*/
func (a *InfoControllerApiService) GetNodeId(ctx context.Context) (string, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/info/nodeID"
...
*/
func (a *InfoControllerApiService) GetVersion(ctx context.Context) (map[string]string, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
